...
import { useState, useRef, type RefObject, SetStateAction, Dispatch } from "react";
...
interface TagInputProps {
    ...
    error?: string;
    // mealTags: Tag[]
    // setMealTags: Dispatch<SetStateAction<string>>
}
            ...
            >
                ...
                <input
                    ...
                    className={cn(
                        ...
                        "focus:outline-hidden rounded border border-green-400"
                    )}
                />
